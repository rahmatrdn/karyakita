...
func (h *userHandler) RegisterUser(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Register account failed [2], contact Customer Service", http.StatusBadRequest, "error", nil)
	...
	if err != nil {
		response := helper.APIResponse("Register account failed [3], contact Customer Service", http.StatusBadRequest, "error", nil)
...
func (h *userHandler) Login(c *gin.Context) {
	...
	if err != nil {
		response := helper.APIResponse("Login failed, please contact Customer Service", http.StatusBadRequest, "error", nil)
